...
# training options
parser.add_argument('--root', type=str, default='./ws/image/*.jpg')
...
parser.add_argument('--mask_root', type=str, default='./ws/mask_ws')
...
evaluate_new(model, dataset_val, device, './ws/inpaint/result.jpg')
