...
# training options
parser.add_argument('--root', type=str, default='./srv/datasets/coco')
parser.add_argument('--mask_root', type=str, default='./mask')
parser.add_argument('--save_dir', type=str, default='./snapshots/default')
parser.add_argument('--log_dir', type=str, default='./logs/default')
parser.add_argument('--lr', type=float, default=2e-3) ## 2e-3
parser.add_argument('--lr_finetune', type=float, default=1e-4) ## 5e-4
parser.add_argument('--max_iter', type=int, default=1070000 + 10000)
